...
class SegmentationModule(SegmentationModuleBase):
    ...
    def forward(self, feed_dict_, use_disc, *, segSize=None):
        ...
        if segSize is None:
            ...
            true_pred = torch.cat([one_hot_labels[:,:,:,1:], one_hot_labels[:,:,:,0:1]], axis = 3)
            ...
            pred_aux = torch.cat([pred, add_class], axis = 1)
